...
namespace ProjectDB
{
    public class ProjectCLI
    {
        ...
        private void CreateProject()
        {
            ...
            ProjectSqlDAL dal = new ProjectSqlDAL(DatabaseConnection);
            int id = dal.CreateProject(newProj);
        ...
        private void CreateDepartment()
        {
            ...
            int id = dal.CreateDepartment(newDept);
        ...
        private void GetAllEmployees()
        {
            ...
            IList<Employee> employees = dal.GetAllEmployees();
        ...
        {
            EmployeeSqlDAL dal = new EmployeeSqlDAL(DatabaseConnection);
            IList<Employee> employees = dal.GetEmployeesWithoutProjects();
